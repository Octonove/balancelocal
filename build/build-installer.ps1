# Genera el instalador de BalanceLocal con Inno Setup. Reconstruye el dist por
# defecto; -SkipBuild lo reutiliza. Version = APP_VERSION (fuente unica).
param([switch]$SkipBuild)

$ErrorActionPreference = "Stop"
$root = Split-Path -Parent $PSScriptRoot
$distExe = Join-Path $root "dist\BalanceLocal\BalanceLocal.exe"
...
$initPy = Join-Path $root "balancelocal\__init__.py"
